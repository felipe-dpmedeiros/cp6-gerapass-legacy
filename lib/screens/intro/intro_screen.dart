...
class _IntroScreenState extends State<IntroScreen> {
  ...
  final List<Map<String, String>> _pages = [
    ...
    {
      'title': 'Vamos começar?',
      'subtitle': 'Pronto para usar seu app com segurança.',
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (_currentPage > 0)
                    TextButton(onPressed: _onBack, child: Text('Voltar', style: const TextStyle(color: Colors.blue)))
                  else
                    SizedBox(width: 80), // espaço para alinhar
                  TextButton(
                    onPressed: _onNext,
                    child: Text(isLastPage ? 'Concluir' : 'Avançar', style: const TextStyle(color: Colors.blue)),
                  ),
                ],
              ),
            ),
